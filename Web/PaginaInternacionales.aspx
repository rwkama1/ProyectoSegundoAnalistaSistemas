<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaginaInternacionales.aspx.cs" Inherits="PaginaInternacionales" %>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td>
                    &nbsp;</td>
                <td>
                    <asp:Repeater ID="RTInternacionales" runat="server" 
                        onitemcommand="RTInternacionales_ItemCommand">
                        <ItemTemplate>
                    <table>
                         <tr bgcolor="#CCFF99">
