<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaginaPolitica.aspx.cs" Inherits="PaginaPolitica" %>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td>
                    &nbsp;</td>
                <td>
                    <asp:Repeater ID="RTPoliticas" runat="server" 
                        onitemcommand="RTPoliticas_ItemCommand">
                       <ItemTemplate>
                    <table>
                         <tr bgcolor="#CCFF99">
